...
CREATE POLICY "Users can insert roles" ON roles FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "Users can update roles" ON roles FOR UPDATE TO authenticated USING (true);
CREATE POLICY "Users can delete roles" ON roles FOR DELETE TO authenticated USING (true);
...
CREATE POLICY "Users can update permissions" ON permissions FOR UPDATE TO authenticated USING (true);
...
CREATE POLICY "Users can insert user_roles" ON user_roles FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "Users can update user_roles" ON user_roles FOR UPDATE TO authenticated USING (true);
CREATE POLICY "Users can delete user_roles" ON user_roles FOR DELETE TO authenticated USING (true);

CREATE POLICY "Users can view role_permissions" ON role_permissions FOR SELECT TO authenticated USING (true);
CREATE POLICY "Users can insert role_permissions" ON role_permissions FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "Users can update role_permissions" ON role_permissions FOR UPDATE TO authenticated USING (true);
CREATE POLICY "Users can delete role_permissions" ON role_permissions FOR DELETE TO authenticated USING (true);
...
-- Create roles for each permission
INSERT INTO roles (name)
...
SELECT r.id, p.id
FROM roles r
JOIN permissions p ON p.name = r.name
ON CONFLICT DO NOTHING;
