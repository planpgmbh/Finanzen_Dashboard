/*
  # Running Costs Initial Data

  1. Insert initial data for years 2023-2025 with monthly costs for each category
  2. Categories:
    - Miete (€2,500/month)
    - Strom (€180/month)
    - Internet & Telefon (€150/month)
    - Versicherungen (€350/month)
    - Software-Lizenzen (€300/month)
*/
